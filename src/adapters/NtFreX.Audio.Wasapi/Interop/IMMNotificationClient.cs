...
namespace NtFreX.Audio.Wasapi.Interop
{
    ...
    internal interface IMMNotificationClient
    {
        ...
        /// </returns>
        [PreserveSig]
        HResult OnDeviceStateChanged([In, MarshalAs(UnmanagedType.LPWStr)] string deviceId, [In] DeviceState deviceState);
        ...
        /// </returns>
        [PreserveSig]
        HResult OnPropertyValueChanged([In, MarshalAs(UnmanagedType.LPWStr)] string deviceId, [In] object key);
    }
}
